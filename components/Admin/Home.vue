<template>
  <div class="container mt-4 custom-bottom-margin">
    <header class="header">
      <div class="left-content">
        ...
        <div class="title">
          ...
          <h1 class="catalog-title">DASHBOARD</h1>
        </div>
      </div>
    ...
    <div style="margin-top: 20px">
        ...
        <tbody>
          <tr v-for="(row, index) in tableData" :key="index">
            ...
            <td class="actions-column">
              ...
              <button class="action-btn">
                <img
                  src="assets/static-images/picture.png"
                  alt="Picture"
                  class="action-icon"
                />
              </button>
      ...
      <div class="d-flex justify-content-between align-items-center">
        <span>Showing 1 of 5000 pages</span>
...
const tableData = [
  {
    ...
    course: "EE",
    paperRequest: "The Founder of Lorem Ipsum Lorem Ipsum",
    dateRequest: "03/23/2024",
    status: "approved",
  },
  {
    name: "Chang Chong",
  ...
  },
  {
    ...
    email: "ching@gmail.com",
    course: "EE",
    paperRequest: "The Founder of Lorem The Founder of Lorem  Ipsum Lorem Ipsum",
    dateRequest: "03/23/2024",
    status: "approved",
  },
  {
