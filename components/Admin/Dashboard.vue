    ...
    <div class="search-bar-container" style="margin-top: 120px;">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex w-50 position-relative">
          <input type="text" class="form-control search-bar" placeholder="Find..." />
            <img src="assets/static-images/search-eye.png" alt="Search Icon" class="search-icon" />
          <button class="btn btn-outline-secondary custom-btn" @click="toggleFilter" ref="filterButton">
            <img src="assets/static-images/filter.png" alt="Filter Icon" class="filter-icon" />
          </button>
      ...
      <table class="table table-hover">
        <thead class="table-light">
          <tr>
            ...
            <th>Name
              <img src="assets/static-images/arrow-down.png" alt="User Icon" class="arrow-down" />
            </th>
            <th>Email
              <img src="assets/static-images/arrow-down.png" alt="User Icon" class="arrow-down" />
            </th>
        ...
        <tbody>
          <tr v-for="(row, index) in tableData" :key="index">
            ...
            <td class="paper-request-column scrollable">{{ row.paperRequest }}</td>
            <td class="date-request-column">{{ row.dateRequest }}</td>
            <td class="actions-column">
              <button class="action-btn">
                <img src="assets/static-images/file-check.png" alt="Approved" class="action-icon" />
              </button>
              <button class="action-btn">
                <img src="assets/static-images/bin.png" alt="Delete" class="action-icon" />
              </button>
            </td>
...
const closeFilter = (event: MouseEvent) => {
  ...
  if (showFilter.value && !target.closest('.filter-dropdown') && !target.closest('.custom-btn')) {
